...
> **⚠️ Important**: This demo uses Filecoin Calibration testnet, which has a retention period of approximately 1 week. For production use, you'll need to migrate to Filecoin mainnet.
